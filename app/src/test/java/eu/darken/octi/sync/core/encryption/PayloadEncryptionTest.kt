...
class PayloadEncryptionTest : BaseTest() {
    ...
    fun `pass existing encryption key`() {
        val encryptionkey =
            "CMyhkP8HEoQBCngKMHR5cGUuZ29vZ2xlYXBpcy5jb20vZ29vZ2xlLmNyeXB0by50aW5rLkFlc1NpdktleRJCEkDAEayVsnPs8JIV0wrVP3EuGuM8dEkIxw0gqyuNJGDqJAQoAJB44ZS9JayECYZ/mUv13oslpQ+Vxjj98je6InGMGAEQARjMoZD/ByAB".decodeBase64()!!
        val encryptedData = "AX/kEMzK2BAPQAjQuafZ3k/kF4fiwsEYAu5h/exhpZaeYkU0".decodeBase64()!!
        val testData = "Banana Pancakes".toByteString()

        val crypti = PayloadEncryption(encryptionkey)
