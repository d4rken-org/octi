 ...
 * is hosted outside the app process) into the existing Octi Pro upgrade flow. Flavour-specific
 * binding decides what the destination screen does (sponsor flow on FOSS, IAP on Gplay).
 *
